                        ...
                        <div class="card-body card-dashboard">
                            <form action="{{route('admin.search.submit')}}" method="get">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" id="ref_id" name="ref_id" class="form-control is-valid" placeholder="Enter referral code">
                                </div>
                    ...
                    <div class="card-content">
                        <div class="card-body card-dashboard">
                            <table class="table-bordered table">
                                ...
                                <tr>
                                    <td>User Invest Balance</td>
                                    <td>{{price($user->invest_balance)}}</td>
                                </tr>
                                <tr>
                                    <td>User Commission Balance</td>
                                    <td>{{price($user->commission_balance)}}</td>
                                </tr>
                                <tr>
                                    <td>User Status</td>
                                    <td>{{$user->status}}</td>
