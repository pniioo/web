...
<link rel="stylesheet" href="{{asset('spin/spain.css')}}">
<style>
    #spin-container {
        text-align: center;
...
<div class="spin_banner"
     style="background: linear-gradient(rgba(139, 21, 154, .4), rgba(139, 21, 154, 1)), url('{{asset('spin/image')}}/s_banner.jpg') no-repeat;
...
<div id="spin-container">
    ...
    <div id="spinner" class="spin-to-win">
        <div>
            <img id="spinerImage" src="{{asset('spin/image')}}/spin.png" />
        </div>
        <div id="spin">
            <img id="spin_round" onclick="CHECK_SPIN_CODE()" src="{{asset('spin/image')}}/draw-now.png">
        </div>
    </div>
    ...
    <div class="rules">
        <img class="ribbon" src="{{asset('spin/image')}}/ribbon3.png">
...
{{--<script src="{{asset('spin/spain.js')}}"></script>--}}
